...
const QImage * RotateImage::rotateAnyPoint(const qreal alpha, const qreal x, const qreal y, const int sw, const int sh) {
   ...
   rotatedImage = new QImage(sw,sh,QImage::Format_RGB32);
...
const QImage * RotateImage::rotateCutBackground(const qreal alpha) {
